...
```
npm install cloudiator-rest-api@1.5.0 --save
```
...
```
import { DefaultApi } from 'cloudiator-rest-api';
...
```
import { BASE_PATH } from 'cloudiator-rest-api';
