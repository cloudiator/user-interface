...
export declare namespace Location {
    type LocationScopeEnum = 'PROVIDER' | 'REGION' | 'ZONE' | 'HOST';
    const LocationScopeEnum: {
        PROVIDER: LocationScopeEnum;
        REGION: LocationScopeEnum;
        ZONE: LocationScopeEnum;
        HOST: LocationScopeEnum;
    };
}
