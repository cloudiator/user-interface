import {
  ...
  Hardware,
  Image, IpAddress, IpAddressType, IpVersion,
  Job,
  LanceInterface,
  Location,
  Login,
...
export const brokenIpAddress: IpAddress = {
  value: '',
  // @ts-ignore
  IpAddressType: IpAddressType.PUBLICIP,
  IpVersion: IpVersion.V4
};
export const correctIpAddress: IpAddress = {
  value: '',
  ipAddressType: IpAddressType.PUBLICIP,
  ipVersion:  IpVersion.V4
};
